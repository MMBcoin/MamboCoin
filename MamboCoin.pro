...
SECP256K1_INCLUDE_PATH=/usr/local/lib/secp256k1/include
}
OBJECTS_DIR = build
MOC_DIR = build
UI_DIR = build
...
FORMS += \
	...
	src/qt/forms/roireportdialog.ui \
...
macx:ICON = src/qt/res/icons/MamboCoin.icns
macx:TARGET = "MamboCoin"
