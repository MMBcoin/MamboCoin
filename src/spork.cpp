...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_6_PROTOCOL_V2_ENFORCEMENT) r = SPORK_6_PROTOCOL_V2_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if(strName == "SPORK_6_PROTOCOL_V2_ENFORCEMENT") return SPORK_6_PROTOCOL_V2_ENFORCEMENT_DEFAULT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if(id == SPORK_6_PROTOCOL_V2_ENFORCEMENT) return "SPORK_6_PROTOCOL_V2_ENFORCEMENT_DEFAULT";
