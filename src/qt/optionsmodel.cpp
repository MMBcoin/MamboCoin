...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeMamboCoinAmount"))
        settings.setValue("nAnonymizeMamboCoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeMamboCoinAmount = settings.value("nAnonymizeMamboCoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeMamboCoinAmount"))
        SoftSetArg("-anonymizeMamboCoinamount", settings.value("nAnonymizeMamboCoinAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeMamboCoinAmount:
            nAnonymizeMamboCoinAmount = value.toInt();
